...
export default function AuthPage() {
  ...
  const handleEmailAuth = async () => {
    ...
    // Store the user's email in localStorage to simulate authentication
    ...
    // Navigate to the onboarding or home page
    setTimeout(() => {
  ...
  const handleGoogleSignIn = () => {
    // Store a demo email in localStorage to simulate authentication
    localStorage.setItem("user_email", "google_user@example.com");
  ...
  const handleAppleSignIn = () => {
    // Store a demo email in localStorage to simulate authentication
    localStorage.setItem("user_email", "apple_user@example.com");
